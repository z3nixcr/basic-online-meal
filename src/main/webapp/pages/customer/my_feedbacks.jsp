      ...
      <div class="ordered-meals">
        <c:if test="${feedbacks != null}">
          <table class="orders-table">
            ...
            <tbody>
            <c:forEach var="feedback" items="${feedbacks}" varStatus="index">
              <tr>
                <td>${index.count}</td>
                ...
                <td>${feedback.rate}</td>
                <td>
                  <a href="${pageContext.request.contextPath}/ServletFeedback?action=edit&id=${feedback.feedBackId}">
                ...
                <td>
                  <a href="${pageContext.request.contextPath}/ServletFeedback?action=delete&id=${feedback.feedBackId}">
